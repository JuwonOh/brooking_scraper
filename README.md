...
크롤러의 파이썬 파일은 util.py, scraper.py, parser.py, downloader.py 그리고 scraping_latest_news.py 총 네가지로 구성되어 있습니다. 
...
downloader.py는 reserch paper와 Brookings papers on economy activity article의 pdf파일을 다운 받아주는 .py 파일입니다.
